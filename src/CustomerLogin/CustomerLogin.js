                            ...
                            <section className="card-body">
                                <form>
                                    <section className="mb-3">
                                        <label htmlFor="exampleInputEmail1" className="form-label">Customer Id</label>
                                        <input type="email" className="form-control" id="exampleInputEmail1" placeholder="Enter Customer Id" />
                                    </section>
                                    <section className="mb-3">
                                    ...
                                    <section className="d-flex justify-content-between">
                                        <section className="d-flex align-items-center">
                                            <a onClick={navigateToManagerLogin} className="btn btn-link mt-3">Sign in as Organisation</a>
                                        </section>
                                        <section className="d-flex align-items-center">
                                            <a onClick={navigateToCustomerHome} className="btn btn-primary mt-3">Submit</a>
                                        </section>
                                    </section>
                                </form>
                            </section>
